    ...
    <div class="project__body">
      ...
      <div class="project__skills">
        ...
        >
          <p
            v-if="skills[skill]"
            class="project__skill !bg-opacity-20"
...
.project {
  ...
  .project__skills {
    ...
    .project__skill {
      @apply border rounded-md flex flex-row font-semibold bg-gray-700 border-villa-green-50/15 text-white py-1 px-2 gap-1.5 relative items-center justify-center bg-opacity-20 #{!important};
  ...
  &:hover {
    ...
    &:not(.project__no-img) {
      .project__body {
        .project__title {
          @apply border-b rounded-b-md bg-gray-900/40 border-villa-green-200/20 -m-6 text-lg py-2 px-3 backdrop-blur-md;
        }
